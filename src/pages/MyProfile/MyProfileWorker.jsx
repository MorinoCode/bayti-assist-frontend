...
import { User, Mail, Phone, Lock, Trash2, Camera, Copy } from 'lucide-react';
...
const MyProfileWorker = () => {
  ...
  const handleWhatsAppShare = () => {
    const text = `Hello! My Worker ID is: ${user._id}. You can add me to your team on WhereKhadame.`;
    ...
    <div className="profile-container animate-fade">
      <div className="profile-content">
            ...
            <div className="user-meta">
              ...
              <div className="worker-id-pill">
                ...
                <div className="pill-actions">
                  ...
                  <button className="whatsapp-share-btn-pill" onClick={handleWhatsAppShare} title="Share to WhatsApp">
        ...
        <div className="profile-grid">
          <div className="profile-main-col full-width">
